...
export declare const API: {
    ...
    readonly issueTreeControl: "/api/issues/:issueId/tree-control";
    readonly issueTreeHolds: "/api/issues/:issueId/tree-holds";
    readonly goals: "/api/goals";
    readonly approvals: "/api/approvals";
    readonly secrets: "/api/secrets";
    readonly secretProviderConfigs: "/api/secret-provider-configs";
