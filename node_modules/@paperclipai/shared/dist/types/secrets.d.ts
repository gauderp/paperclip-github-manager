import type { SecretAccessOutcome, SecretBindingTargetType, SecretManagedMode, SecretProvider, SecretProviderConfigHealthStatus, SecretProviderConfigStatus, SecretStatus, SecretVersionStatus } from "../constants.js";
export type { SecretAccessOutcome, SecretBindingTargetType, SecretManagedMode, SecretProvider, SecretProviderConfigHealthStatus, SecretProviderConfigStatus, SecretStatus, SecretVersionStatus, };
...
export type SecretProviderConfigPayload = LocalEncryptedProviderConfig | AwsSecretsManagerProviderConfig | GcpSecretManagerProviderConfig | VaultProviderConfig;
