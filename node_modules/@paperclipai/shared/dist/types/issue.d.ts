import type { IssueCommentAuthorType, IssueCommentMetadataRowType, IssueCommentPresentationKind, IssueCommentPresentationTone, IssueExecutionMonitorClearReason, IssueExecutionMonitorKind, IssueExecutionMonitorRecoveryPolicy, IssueExecutionMonitorStateStatus, IssueExecutionDecisionOutcome, IssueMonitorScheduledBy, IssueExecutionPolicyMode, IssueReferenceSourceKind, IssueExecutionStageType, IssueExecutionStateStatus, IssueOriginKind, IssuePriority, IssueRecoveryActionKind, IssueRecoveryActionOutcome, IssueRecoveryActionOwnerType, IssueRecoveryActionStatus, IssueWorkMode, ModelProfileKey, IssueThreadInteractionContinuationPolicy, IssueThreadInteractionKind, IssueThreadInteractionStatus, IssueStatus } from "../constants.js";
...
export type IssueBlockerAttentionReason = "active_child" | "active_dependency" | "stalled_review" | "attention_required" | null;
...
export type IssueProductivityReviewTrigger = "no_comment_streak" | "long_active_duration" | "high_churn";
...
export type IssueRetryNowOutcome = "promoted" | "already_promoted" | "no_scheduled_retry" | "gate_suppressed";
...
export type IssueCommentMetadataRow = IssueCommentMetadataTextRow | IssueCommentMetadataCodeRow | IssueCommentMetadataKeyValueRow | IssueCommentMetadataIssueLinkRow | IssueCommentMetadataAgentLinkRow | IssueCommentMetadataRunLinkRow;
...
export type RequestConfirmationTarget = RequestConfirmationIssueDocumentTarget | RequestConfirmationCustomTarget;
...
export type IssueThreadInteraction = SuggestTasksInteraction | AskUserQuestionsInteraction | RequestConfirmationInteraction;
export type IssueThreadInteractionPayload = SuggestTasksPayload | AskUserQuestionsPayload | RequestConfirmationPayload;
export type IssueThreadInteractionResult = SuggestTasksResult | AskUserQuestionsResult | RequestConfirmationResult;
