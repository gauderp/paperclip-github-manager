...
export declare const updateMemberPermissionsSchema: z.ZodObject<{
    grants: z.ZodArray<z.ZodObject<{
        permissionKey: z.ZodEnum<["agents:create", "environments:manage", "users:invite", "users:manage_permissions", "tasks:assign", "tasks:assign_scope", "tasks:manage_active_checkouts", "joins:approve"]>;
        scope: z.ZodNullable<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
    }, "strip", z.ZodTypeAny, {
        permissionKey: "agents:create" | "environments:manage" | "users:invite" | "users:manage_permissions" | "tasks:assign" | "tasks:assign_scope" | "tasks:manage_active_checkouts" | "joins:approve";
