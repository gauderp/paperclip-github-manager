...
export declare const createFinanceEventSchema: z.ZodEffects<z.ZodObject<{
    ...
    executionAdapterType: z.ZodNullable<z.ZodOptional<z.ZodEnum<["process", "http", "acpx_local", "claude_local", "codex_local", "cursor_cloud", "gemini_local", "opencode_local", "pi_local", "cursor", "openclaw_gateway"]>>>;
    ...
    executionAdapterType?: "process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | null | undefined;
