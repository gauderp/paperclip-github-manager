...
export declare const DEFAULT_COMPANY_ATTACHMENT_MAX_BYTES: number;
export declare const MAX_COMPANY_ATTACHMENT_MAX_BYTES: number;
...
export declare const AGENT_ADAPTER_TYPES: readonly ["process", "http", "acpx_local", "claude_local", "codex_local", "cursor_cloud", "gemini_local", "opencode_local", "pi_local", "cursor", "openclaw_gateway"];
export type AgentAdapterType = (typeof AGENT_ADAPTER_TYPES)[number] | (string & {});
export declare const AGENT_ROLES: readonly ["ceo", "cto", "cmo", "cfo", "security", "engineer", "designer", "pm", "qa", "devops", "researcher", "general"];
export type AgentRole = (typeof AGENT_ROLES)[number];
export declare const AGENT_ROLE_LABELS: Record<AgentRole, string>;
export declare const AGENT_DEFAULT_MAX_CONCURRENT_RUNS = 20;
export declare const WORKSPACE_BRANCH_ROUTINE_VARIABLE = "workspaceBranch";
export declare const MODEL_PROFILE_KEYS: readonly ["cheap"];
...
export declare const ISSUE_WORK_MODES: readonly ["standard", "planning"];
export type IssueWorkMode = (typeof ISSUE_WORK_MODES)[number];
export declare const MAX_ISSUE_REQUEST_DEPTH = 1024;
export declare const ISSUE_COMMENT_AUTHOR_TYPES: readonly ["user", "agent", "system"];
export type IssueCommentAuthorType = (typeof ISSUE_COMMENT_AUTHOR_TYPES)[number];
export declare const ISSUE_COMMENT_PRESENTATION_KINDS: readonly ["message", "system_notice"];
export type IssueCommentPresentationKind = (typeof ISSUE_COMMENT_PRESENTATION_KINDS)[number];
export declare const ISSUE_COMMENT_PRESENTATION_TONES: readonly ["neutral", "info", "success", "warning", "danger"];
export type IssueCommentPresentationTone = (typeof ISSUE_COMMENT_PRESENTATION_TONES)[number];
export declare const ISSUE_COMMENT_METADATA_ROW_TYPES: readonly ["text", "code", "key_value", "issue_link", "agent_link", "run_link"];
export type IssueCommentMetadataRowType = (typeof ISSUE_COMMENT_METADATA_ROW_TYPES)[number];
export declare function clampIssueRequestDepth(value: number | null | undefined): number;
...
export declare const ISSUE_THREAD_INTERACTION_STATUSES: readonly ["pending", "accepted", "rejected", "answered", "cancelled", "expired", "failed"];
...
export declare const ISSUE_ORIGIN_KINDS: readonly ["manual", "routine_execution", "stale_active_run_evaluation", "harness_liveness_escalation", "issue_productivity_review", "stranded_issue_recovery"];
export type BuiltInIssueOriginKind = (typeof ISSUE_ORIGIN_KINDS)[number];
export type PluginIssueOriginKind = `plugin:${string}`;
export type IssueOriginKind = BuiltInIssueOriginKind | PluginIssueOriginKind;
export declare const ISSUE_SURFACE_VISIBILITIES: readonly ["default", "plugin_operation"];
export type IssueSurfaceVisibility = (typeof ISSUE_SURFACE_VISIBILITIES)[number];
export declare const ISSUE_RECOVERY_ACTION_KINDS: readonly ["missing_disposition", "stranded_assigned_issue", "active_run_watchdog", "issue_graph_liveness"];
export type IssueRecoveryActionKind = (typeof ISSUE_RECOVERY_ACTION_KINDS)[number];
export declare const ISSUE_RECOVERY_ACTION_STATUSES: readonly ["active", "escalated", "resolved", "cancelled"];
export type IssueRecoveryActionStatus = (typeof ISSUE_RECOVERY_ACTION_STATUSES)[number];
export declare const ISSUE_RECOVERY_ACTION_OWNER_TYPES: readonly ["agent", "user", "board", "system"];
export type IssueRecoveryActionOwnerType = (typeof ISSUE_RECOVERY_ACTION_OWNER_TYPES)[number];
export declare const ISSUE_RECOVERY_ACTION_OUTCOMES: readonly ["restored", "delegated", "false_positive", "blocked", "escalated", "cancelled"];
export type IssueRecoveryActionOutcome = (typeof ISSUE_RECOVERY_ACTION_OUTCOMES)[number];
export declare function pluginOperationIssueOriginKind(pluginKey: string): PluginIssueOriginKind;
export declare function isPluginOperationIssueOriginKind(originKind: string | null | undefined): boolean;
export declare const ISSUE_RELATION_TYPES: readonly ["blocks"];
export type IssueRelationType = (typeof ISSUE_RELATION_TYPES)[number];
export declare const ISSUE_TREE_CONTROL_MODES: readonly ["pause", "resume", "cancel", "restore"];
export type IssueTreeControlMode = (typeof ISSUE_TREE_CONTROL_MODES)[number];
export declare const ISSUE_TREE_HOLD_STATUSES: readonly ["active", "released"];
export type IssueTreeHoldStatus = (typeof ISSUE_TREE_HOLD_STATUSES)[number];
export declare const ISSUE_TREE_HOLD_RELEASE_POLICY_STRATEGIES: readonly ["manual", "after_active_runs_finish"];
...
export declare const ISSUE_MONITOR_SCHEDULED_BY: readonly ["assignee", "board"];
export type IssueMonitorScheduledBy = (typeof ISSUE_MONITOR_SCHEDULED_BY)[number];
export declare const ISSUE_EXECUTION_MONITOR_KINDS: readonly ["external_service"];
export type IssueExecutionMonitorKind = (typeof ISSUE_EXECUTION_MONITOR_KINDS)[number];
export declare const ISSUE_EXECUTION_MONITOR_RECOVERY_POLICIES: readonly ["wake_owner", "create_recovery_issue", "escalate_to_board"];
export type IssueExecutionMonitorRecoveryPolicy = (typeof ISSUE_EXECUTION_MONITOR_RECOVERY_POLICIES)[number];
export declare const ISSUE_EXECUTION_STATE_STATUSES: readonly ["idle", "pending", "changes_requested", "completed"];
export type IssueExecutionStateStatus = (typeof ISSUE_EXECUTION_STATE_STATUSES)[number];
export declare const ISSUE_EXECUTION_MONITOR_STATE_STATUSES: readonly ["scheduled", "triggered", "cleared"];
export type IssueExecutionMonitorStateStatus = (typeof ISSUE_EXECUTION_MONITOR_STATE_STATUSES)[number];
export declare const ISSUE_EXECUTION_MONITOR_CLEAR_REASONS: readonly ["manual", "triggered", "done", "cancelled", "invalid_status", "invalid_assignee", "dispatch_skipped", "timeout_exceeded", "max_attempts_exhausted"];
export type IssueExecutionMonitorClearReason = (typeof ISSUE_EXECUTION_MONITOR_CLEAR_REASONS)[number];
export declare const ISSUE_EXECUTION_DECISION_OUTCOMES: readonly ["approved", "changes_requested"];
...
export declare const ENVIRONMENT_DRIVERS: readonly ["local", "ssh", "sandbox", "plugin"];
...
export declare const ENVIRONMENT_LEASE_STATUSES: readonly ["active", "released", "expired", "failed", "retained"];
export type EnvironmentLeaseStatus = (typeof ENVIRONMENT_LEASE_STATUSES)[number];
export declare const ENVIRONMENT_LEASE_POLICIES: readonly ["ephemeral", "reuse_by_environment", "reuse_by_execution_workspace", "retain_on_failure"];
...
export declare const ROUTINE_TRIGGER_SIGNING_MODES: readonly ["bearer", "hmac_sha256", "github_hmac", "none"];
...
export declare const APPROVAL_TYPES: readonly ["hire_agent", "approve_ceo_strategy", "budget_override_required", "request_board_approval"];
...
export declare const SECRET_PROVIDER_CONFIG_STATUSES: readonly ["ready", "warning", "coming_soon", "disabled"];
export type SecretProviderConfigStatus = (typeof SECRET_PROVIDER_CONFIG_STATUSES)[number];
export declare const SECRET_PROVIDER_CONFIG_HEALTH_STATUSES: readonly ["ready", "warning", "error", "coming_soon", "disabled"];
export type SecretProviderConfigHealthStatus = (typeof SECRET_PROVIDER_CONFIG_HEALTH_STATUSES)[number];
export declare const SECRET_STATUSES: readonly ["active", "disabled", "archived", "deleted"];
export type SecretStatus = (typeof SECRET_STATUSES)[number];
export declare const SECRET_MANAGED_MODES: readonly ["paperclip_managed", "external_reference"];
export type SecretManagedMode = (typeof SECRET_MANAGED_MODES)[number];
export declare const SECRET_VERSION_STATUSES: readonly ["current", "previous", "disabled", "destroyed", "failed"];
export type SecretVersionStatus = (typeof SECRET_VERSION_STATUSES)[number];
export declare const SECRET_BINDING_TARGET_TYPES: readonly ["agent", "project", "environment", "routine", "plugin", "issue", "run", "system"];
export type SecretBindingTargetType = (typeof SECRET_BINDING_TARGET_TYPES)[number];
export declare const SECRET_ACCESS_OUTCOMES: readonly ["success", "failure"];
...
export declare const PERMISSION_KEYS: readonly ["agents:create", "environments:manage", "users:invite", "users:manage_permissions", "tasks:assign", "tasks:assign_scope", "tasks:manage_active_checkouts", "joins:approve"];
 ...
 */
export declare const PLUGIN_UI_SLOT_TYPES: readonly ["page", "detailTab", "taskDetailView", "dashboardWidget", "sidebar", "routeSidebar", "sidebarPanel", "projectSidebarItem", "globalToolbarButton", "toolbarButton", "contextMenuItem", "commentAnnotation", "commentContextMenuItem", "settingsPage"];
