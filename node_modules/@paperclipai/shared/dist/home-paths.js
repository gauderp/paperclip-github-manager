...
export function resolvePaperclipHomeDir(homeOverride) {
    const raw = homeOverride?.trim() || process.env.PAPERCLIP_HOME?.trim();
    if (raw)
        return path.resolve(expandHomePrefix(raw));
    return path.resolve(os.homedir(), ".paperclip");
}
export function resolvePaperclipInstanceId(instanceIdOverride) {
...
export function resolvePaperclipEnvPathForConfig(configPath) {
