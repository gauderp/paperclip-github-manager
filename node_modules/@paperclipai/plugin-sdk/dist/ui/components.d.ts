 ...
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const MarkdownEditor: React.ComponentType<MarkdownEditorProps>;
/**
 ...
 * ```
 */
export declare const FileTree: React.ComponentType<FileTreeProps>;
/**
 * Renders Paperclip's native issue list component for company-scoped plugin
 * pages that need a standard board issue view.
 */
export declare const IssuesList: React.ComponentType<IssuesListProps>;
/**
 * Renders the same host assignee picker used by the new issue pane.
 */
export declare const AssigneePicker: React.ComponentType<AssigneePickerProps>;
/**
 * Renders the same host project picker used by the new issue pane.
 */
export declare const ProjectPicker: React.ComponentType<ProjectPickerProps>;
/**
 * Renders Paperclip's native managed routines list for plugin settings pages.
 */
export declare const ManagedRoutinesList: React.ComponentType<ManagedRoutinesListProps>;
